...
/*
 * The file QuickSort.txt contains all of the integers between 1 and 10,000 (inclusive, with
...
public class QuickSort1 {
    ...
    public static void main(String[] args) throws IOException {
        String packageName = "";
        try {
            packageName = new QuickSort1().getClass().getPackage().toString().split(" ")[1] + "/";
